...
var (
	всего int           //Общее число транзисторов
	блок  мСинх.RWMutex //Глобальная блокировка для счётчика транзисторов
)
...
//Всего -- возвращает общее число транзисторов
func Всего() int {
	defer блок.RUnlock()
	блок.RLock()
	return всего
